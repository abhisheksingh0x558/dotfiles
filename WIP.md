...
- [ ] Fix zinit generate lockfile script
...
- [ ] Add git diff aliases
- [ ] Use treesitter for highlighting todos in emacs
...
- [ ] Setup textobject for comments in neovim
...
- [ ] Use delta for chezmoi diff and other tools which use git as well
...
- [ ] Setup ubi, aqua, asdf, vfox, vagrant, arkade, flox, spack, webi
...
- [ ] Track nix, brew, paru, chezmoi, mise, neovim, emacs, and zsh lockfiles
...
44. Docker cli, tui, gui with Kubernetes, Knative, Opentofu, Terraspace, Openspace
45. Podman cli, tui, gui with Kubernetes, Knative, Opentofu, Terraspace, Openspace
45. Kubectl
46. Containerd
48. Systemd
49. Colima
