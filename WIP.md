...
- [ ] Add go, cargo, pnpm, uv, etc. global bin dirs to path
- [ ] Optimise emacs exec path from shell
...
- [ ] Reorder commits installing langs
- [ ] Fzf history search not working in zsh
