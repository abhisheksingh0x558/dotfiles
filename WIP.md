...
- [ ] Install all emacs and neovim treesitter parsers eagerly when setting up
- [ ] Emacs enable recentf
- [ ] Enable inlay hints and code lens for emacs and neovim lsp
- [ ] Fix neovim treesitter opts, old options are being used as of now
- [ ] Install snacks and mini in neovim
...
- [ ] Document dot cli and source code
- [ ] Use difftastic and delta for chezmoi diff and other tools which use git as well
...
- [ ] Use all lowercase keys and values for dotfiles which are case-insensitive and align commments as well
- [ ] Install opentofu and deprecate terraform
...
- [ ] Install tealdeer, navi, cheat cheatsheets
...
- [ ] Replace zsh with nushell everywhere
- [ ] Try sheldon for zsh, rocks for neovim and something similar for emacs
...
- [ ] Install lens, podman, bazel, pulumi, argocd, eartly, grafana stack
...
- [ ] Setup windsurf, llm language server, llm based refactoring
...
- [ ] Update emacs, neovim, zsh, chezmoi plugins with justfile
- [ ] Update mise, homebrew packages with justfile
- [ ] Add homebrew and pacman registry to mise and remove homebrew and pacman
- [ ] Install and update rustup, pyenv toolchains with justfile
- [ ] Telescope fix height
- [ ] Improve emacs lsp and linter config
- [ ] Consult extensions
...
- [ ] Setup ubi, aqua, asdf, vfox, vagrant
...
- [ ] Install apple command line tools and arch base package via nix
...
- [ ] Check if substituters are required by nixos, nix-darwin and home-manager
...
- [ ] Neovim/Emacs - emmet
- [ ] Neovim/Emacs - git blame mappings
...
- [ ] Neovim - treesitter enable incremental_selection, indent, folding, textobjects select, textobjects swap, textobjects move, textobjects lsp_interop, pairs
- [ ] Emacs - marginalia
- [ ] Emacs - treesit-auto
- [ ] Emacs - embark
- [ ] Emacs - projectile
...
- [ ] Neovim languages - Terraform/terragrunt
...
- [ ] Neovim improvments - Fix telescope theme with dressing
...
- [ ] Neovim plugins - UI/UX - nvim-web-devicons # Icons
...
- [ ] Neovim plugins - UI/UX - dressing-nvim # Improve UI defaults
...
- [ ] Neovim plugins - Filesystem manager - oil-nvim # Explorer in buffer
...
44. Docker cli, tui, gui with Kubernetes, Knative, Terraform, Terraspace, Openspace
45. Podman cli, tui, gui with Kubernetes, Knative, Terraform, Terraspace, Openspace
45. Kubectl
46. Containerd
48. Systemd
49. Colima
