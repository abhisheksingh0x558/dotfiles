...
- [ ] Install comet from homebrew and import karabiner updated config to dotfiles but use my own config
...
- [ ] Remove arch linux
- [ ] Sheldon lazy loading, byte compilation, versioning
...
- [ ] Git alias rev-parse, rev-list, reflog, gc, describe, remote, fsck, pull and push with and without stash, clone --depth --filter tree:0 --filter blob:none, push --progress
