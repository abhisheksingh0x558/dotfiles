...
alias gmm = git merge (git-default-branch)
alias gmo = git merge origin/(git-default-branch)
...
alias gpum = git pull upstream (git-default-branch)
# Git push
alias gph = git push
...
alias gphom = git push origin (git-default-branch)
alias gphum = git push upstream (git-default-branch)
alias gphfom = git push --force-with-lease origin (git-default-branch)
alias gphfum = git push --force-with-lease upstream (git-default-branch)
# Git rebase
alias gr = git rebase
...
alias grm = git rebase (git-default-branch)
alias gro = git rebase origin/(git-default-branch)
alias gru = git rebase upstream/(git-default-branch)
# Git restore
